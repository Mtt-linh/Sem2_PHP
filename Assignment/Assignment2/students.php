...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
        <?php $students = new Assignment\Assignment2\Student.php;
        ?>
        <?php foreach ($students->getStudents() as $s): //thay {} bằng { = : , } = endforeach; ?>
            <tr>
                <th scope="row"><?php echo $s["id"] ?></th>
                <th><a href="Edit_Student.php?id=<?php echo $s["id"]?>">Edit</a></th>
                <td><?php echo $s["name"] ?></td>
                <td><?php echo $s["age"] ?></td>
                <td><?php echo $s["mark"] ?></td>
                <td><a href="Delete_Student.php?id=<?php echo $s["id"]?>">Delete</a></td>
            </tr>
